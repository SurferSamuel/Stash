...
// Need to expose the functions here so that the frontend can call them.
ipcMain.handle("fetchQuote", api.fetchQuote);
ipcMain.handle("getData", api.getData);
ipcMain.handle("setData", api.setData);
